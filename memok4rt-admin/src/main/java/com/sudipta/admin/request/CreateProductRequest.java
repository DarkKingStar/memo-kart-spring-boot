package com.sudipta.admin.request;

import java.util.HashSet;
import java.util.Set;

import com.sudipta.admin.dto.SizeDTO;
...
public class CreateProductRequest {
    ...
    private Set<SizeDTO> size=new HashSet<>();
	...
	public Set<SizeDTO> getSize() {
		return size;
	}
	public void setSize(Set<SizeDTO> size) {
		this.size = size;
	}
